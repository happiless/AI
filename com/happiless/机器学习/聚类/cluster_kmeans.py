...
def main():
    ...
    # 构建了一个样本不均衡的数据集
    data3 = np.vstack((data2[y == 0][:], data2[y == 1][:50], data2[y == 2][:20], data2[y == 3][:5]))
    # 构建data3对应的标签数组
    ...
    plt.suptitle(u'数据分布对KMeans的影响', fontsize=18)
